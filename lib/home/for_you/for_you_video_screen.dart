...
{
  final ControllerForYouVideos controllerVideosForYou = Get.put(ControllerForYouVideos());
                                ...
                                Column(
                                  children: [
                                    ...
                                    IconButton(
                                      onPressed: ()
                                      {
                                        controllerVideosForYou.likeOrUnlikeVideo(eachVideoInfo.videoID.toString());
                                      },
                                      icon: Icon(
